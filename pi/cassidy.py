    ...
    def draw(self):
        for x in range(self.width):
            for y in range(self.height):
                ...
                g = math.sin(self.freq * self.gNoise.noise3(self.scale*x, self.scale*y, z)) * 128 + 128
                b = math.sin(self.freq * self.bNoise.noise3(self.scale*x, self.scale*y, z)) * 128 + 128
