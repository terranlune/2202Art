    ...
    def draw(self):
        for x in range(self.width):
            for y in range(self.height):
                ...
                r = math.sin(self.freq * self.rNoise.noise3(self.scale*x, self.scale*y, z)) * 128 + 128
                g = math.sin(self.freq * self.rNoise.noise3(self.scale*x, self.scale*y, z) + math.pi*4/11) * 128 + 128
                b = math.sin(self.freq * self.rNoise.noise3(self.scale*x, self.scale*y, z) + math.pi*8/11) * 128 + 128
